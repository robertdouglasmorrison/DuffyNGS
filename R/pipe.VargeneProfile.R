# pipe.VargeneProfile.R

# turn RNA-seq data into a profile of Vargene constructs & expression

`pipe.VargeneProfile` <- function( sampleID=NULL, annotationFile="Annotation.txt", optionsFile="Options.txt",
...
showCGpct <- function( seqID=getCurrentSeqMap()$SEQ_ID[1], window=100, col=3, lwd=1, bases=T) {
